export default {
    ...
    dialog: {
        users: {
            ...
            info2_hint: "По умолчанию: <strong>5 конфигураций</strong>",
            info2_hint2: "Рекомендуется: <strong>10–20</strong> для активных пользователей",
            info2_hint3: "Максимум: <strong>100</strong> для доверенных пользователей",
